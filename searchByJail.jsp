...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM criminal,c_Details where criminal.C_ID=c_Details.C_ID and c_Details.Jail_ID like ? limit "+iPageNo+","+iShowRows+"";
