...
%>
    ...
    <tr>
		...
		<td><%= jlid %></td>
		<%  
		out.println("<td><a href='#' onClick=\"modify(\'"+csid+"\',\'"+csno+"\', \'"+jlid+"\')\">Transfer a Jail / Modify</a>	</td>");
		%>
    </tr>
    <% 
 }
...
<%
        ...
        {
         %>
          <a href="jailer_transfer_jail.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a href="jailer_transfer_jail.jsp?iPageNo=<%=i%>" style="cursor:pointer;color:#DAA520"><b><%=i%></b></a>
          <%
          }
          else if(i<=iTotalPages)
          {
          %>
           <a href="jailer_transfer_jail.jsp?iPageNo=<%=i%>"><%=i%></a>
          <% 
          }
        }
        ...
        {
         %>
         <a href="jailer_transfer_jail.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
        }
      %>
