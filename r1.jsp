...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM criminal,c_Details,upload_photo where criminal.C_ID=c_Details.C_ID and criminal.C_ID=upload_photo.C_ID and criminal.C_ID like ? limit "+iPageNo+","+iShowRows+"";
...
%>
	<%
		...
		image = rsPagination.getBlob("Photo");
    ...
    <tr>
		...
		o.close(); %>
		<%
		out.println("<td><a href=\"testshow.jsp?tcid="+ rsPagination.getString("C_ID") + "\">Photo</a></td>");
		%>
		</td>
    </tr>
    <% 
